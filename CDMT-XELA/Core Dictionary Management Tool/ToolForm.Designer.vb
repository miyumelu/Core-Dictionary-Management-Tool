...
Partial Class ToolForm
    ...
    Private Sub InitializeComponent()
        ...
        File_Tree.BackColor = Color.FromArgb(CByte(0), CByte(5), CByte(96))
        File_Tree.BorderStyle = BorderStyle.None
        File_Tree.Font = New Font("LCD", 36F, FontStyle.Regular, GraphicsUnit.Point)
        ...
        Object_Label.Font = New Font("LCD", 48F, FontStyle.Regular, GraphicsUnit.Point)
        Object_Label.ForeColor = Color.FromArgb(CByte(0), CByte(240), CByte(240))
        Object_Label.Location = New Point(396, 97)
        Object_Label.Name = "Object_Label"
        Object_Label.Size = New Size(573, 71)
        ...
        Type_Label.Font = New Font("LCD", 36F, FontStyle.Regular, GraphicsUnit.Point)
        Type_Label.ForeColor = Color.FromArgb(CByte(0), CByte(240), CByte(240))
        Type_Label.Location = New Point(399, 169)
        Type_Label.Name = "Type_Label"
        Type_Label.Size = New Size(392, 52)
        ...
        Content_Box.BackColor = Color.FromArgb(CByte(0), CByte(5), CByte(96))
        Content_Box.BorderStyle = BorderStyle.None
        Content_Box.Font = New Font("LCD", 36F, FontStyle.Regular, GraphicsUnit.Point)
        ...
        Option_Bar.BackColor = Color.FromArgb(CByte(0), CByte(5), CByte(96))
        Option_Bar.Dock = DockStyle.None
        Option_Bar.Font = New Font("LCD", 36F, FontStyle.Regular, GraphicsUnit.Point)
        ...
        Tree_Menu.Size = New Size(120, 76)
        Tree_Menu.Text = "Tree"
        ' 
        ...
        File_Menu.Size = New Size(104, 76)
        File_Menu.Text = "File"
        ' 
        ' Create_Button
        ' 
        ...
        ' LTE_Button
        ' 
        LTE_Button.ForeColor = Color.FromArgb(CByte(0), CByte(240), CByte(240))
        LTE_Button.Name = "LTE_Button"
        LTE_Button.Size = New Size(457, 76)
        LTE_Button.Text = "Light-Term Encryption"
        ' 
        ' ToolStripMenuItem1
        ' 
        ToolStripMenuItem1.Name = "ToolStripMenuItem1"
        ToolStripMenuItem1.Size = New Size(12, 76)
        ' 
        ' BoxBorder
        ' 
        ...
        GetDataContent_Button.BackColor = Color.FromArgb(CByte(0), CByte(5), CByte(96))
        ...
        QuickSave_Button.BackColor = Color.FromArgb(CByte(0), CByte(5), CByte(96))
        QuickSave_Button.FlatAppearance.BorderSize = 3
        ...
        Rename_Button.BackColor = Color.FromArgb(CByte(0), CByte(5), CByte(96))
        Rename_Button.FlatAppearance.BorderSize = 3
        ...
        DoubleBuffered = True
        ForeColor = Color.FromArgb(CByte(0), CByte(240), CByte(240))
